...
const UI_ENV = {
    title: 'Bible de Royaumont (de Nicolas Fontaine)',
    canonical: 'https://royaumont.sacy.be',
    dataBasePath:'',
    uiPath: 'ui',
    ...
    links: [
        {
            ...
            url: 'https://github.com/bible-sacy/bible-royaumont/issues'
        },
        {
            title: 'code source du site web',
            url: 'https://github.com/bible-sacy/bible-royaumont'
        },
        {
